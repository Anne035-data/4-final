...
def train():
    try:
        ...
        # Obtenir la date et l'heure actuelles dans un format lisible
        ...
        with mlflow.start_run() as run:
            ...
            # Log les métriques et paramètres existants
            mlflow.log_params(model.get_params())
            mlflow.log_metric("accuracy", accuracy)
            mlflow.log_metric("f1_score", f1)
            
            # Ajouter des tags avec la date et l'heure lisibles
            client.set_tag(run.info.run_id, "training_date", formatted_time)
